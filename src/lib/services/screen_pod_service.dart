...
import 'package:workspace/enums/iphone_enum.dart';
...
// 基準となるiPhoneのバージョンを指定する
Size baseDeviceSize = IPhoneScreenSize.getSize(IPhoneVersion.iPhone14);

/// 画面サイズの設定値
final screenProvider = ScreenProvider(
  designWidth: baseDeviceSize.width, // iPhone14の幅をデザイン基準にする
  designHeight: baseDeviceSize.height,
  breakpoints: {
